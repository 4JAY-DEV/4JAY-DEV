...
str = f""" \033[1;36mHELLO IN MY TOOL """    
for char in str:
         stdout.write(char)
         stdout.flush()
         sleep(0.001/0.02)
print("")
print("")
str = f""" \033[1;32mTHIS MY CHANNEL »» : https://t.me/black_code_22 """
for char in str:
         stdout.write(char)
         stdout.flush()
         sleep(0.001/0.02)
...
clear()
cyany = '['+termcolor.colored('*','cyan')+'] '

def blue(x):
    return termcolor.colored('')
print("\033[1;31m")
print(pyfiglet.figlet_format('GHOSTATTACK'))

while True:
    def do():
        user = input('\033[1;32mENTER USERNAME : ')
        if user[0] == '@':
            user = user[1:]
